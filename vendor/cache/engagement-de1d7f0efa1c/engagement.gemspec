...
Gem::Specification.new do |s|
  ...
  s.date = "2013-08-14"
  s.description = "A ruby gem for measuring the engagement of URLs on various social sites."
  s.email = ["michael@diminishing.org"]
  s.files = [".gitignore", "Gemfile", "LICENSE.txt", "README.md", "Rakefile", "engagement.gemspec", "lib/engagement.rb", "lib/engagement/comment_counter.rb", "lib/engagement/comment_counter/disqus.rb", "lib/engagement/comment_counter/hacker_news.rb", "lib/engagement/comment_counter/reddit.rb", "lib/engagement/comment_counter/threaded.rb", "lib/engagement/comment_counter/twitter.rb", "lib/engagement/version.rb", "spec/cassettes/Engagement_CommentCounter_Disqus/when_we_don_t_own_the_url/returns_zero_when_we_don_t_own_the_url.yml", "spec/cassettes/Engagement_CommentCounter_Disqus/when_we_own_the_url/returns_the_number_of_comments_for_the_given_url.yml", "spec/cassettes/Engagement_CommentCounter_HackerNews/returns_the_number_of_comments_for_the_given_url.yml", "spec/cassettes/Engagement_CommentCounter_Reddit/with_a_single_listing_returned/.yml", "spec/cassettes/Engagement_CommentCounter_Reddit/with_multiple_listings_returned/.yml", "spec/cassettes/Engagement_CommentCounter_Reddit/with_no_results/.yml", "spec/cassettes/Engagement_CommentCounter_Twitter/returns_the_number_of_comments_for_the_given_url.yml", "spec/engagement/comment_counter/disqus_spec.rb", "spec/engagement/comment_counter/hacker_news_spec.rb", "spec/engagement/comment_counter/reddit_spec.rb", "spec/engagement/comment_counter/twitter_spec.rb", "spec/engagement/comment_counter_spec.rb", "spec/engagement/threaded_comment_counter_spec.rb", "spec/spec_helper.rb"]
  s.homepage = "https://github.com/gaslight/engagement"
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = "2.0.3"
  s.summary = "Get comment counts from Reddit, HackerNews, and Disqus."
