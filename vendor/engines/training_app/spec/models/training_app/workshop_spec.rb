...
module TrainingApp
  describe Workshop do
    context "with registrations" do
      ...
      describe "current" do
        Given!(:old_workshop) { FactoryGirl.create(:workshop, start_date: Date.today - 5.days)}
        Given!(:current_workshop) { FactoryGirl.create(:workshop, start_date: Date.today + 30.days)}
